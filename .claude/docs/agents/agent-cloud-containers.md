...
description: "Pre-installed packages, databases, and utilities available in cloud containers."
category: "agents"
updated: 2026-06-09
source: https://platform.claude.com/docs/en/managed-agents/cloud-sandboxes-reference.md
---
