...
Scripted or Playwright path through lead + showing.

## Global implementation sequence

- **implementation_order:** 21 / 40 (see `V2-real-estate.md/000-index.md`).
**Global predecessor:** `RE-020` (must be complete first).
