...
Single edge for web + future WhatsApp lead rows.

## Global implementation sequence

- **implementation_order:** 6 / 40 (see `V2-real-estate.md/000-index.md`).
**Global predecessor:** `RE-005` (must be complete first).
