...
Enrich top candidates via places-proxy.

## Global implementation sequence

- **implementation_order:** 24 / 40 (see `V2-real-estate.md/000-index.md`).
**Global predecessor:** `RE-023` (must be complete first).
