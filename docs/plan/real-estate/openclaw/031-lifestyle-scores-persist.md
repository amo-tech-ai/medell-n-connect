...
Persist neighborhood scores on listing/venue rows.

## Global implementation sequence

- **implementation_order:** 31 / 40 (see `V2-real-estate.md/000-index.md`).
**Global predecessor:** `RE-030` (must be complete first).
