...
Template sends after Paperclip approval.

## Global implementation sequence

- **implementation_order:** 35 / 40 (see `V2-real-estate.md/000-index.md`).
**Global predecessor:** `RE-034` (must be complete first).
