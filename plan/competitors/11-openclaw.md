Below is a practical research synthesis for **mdeai’s local-intelligence stack**, focused on OpenClaw, restaurant/café discovery, tourism intelligence, map search, and browser automation. The best systems are not static directories; they combine grounded places data, conversational UX, social proof, and automated enrichment loops.openclaw+4

## Executive summary

The strongest commercial references are **Mindtrip**, **Yelp’s updated AI assistant**, and **Foursquare’s location-intelligence platform**, because they connect conversational discovery to structured place data and task execution.techcrunch+2  
The most useful open-source references are **OpenClaw itself**, **travel agent repos built with LangGraph**, and **Instagram place/location extraction repos**, because they show how to automate research, enrichment, and geo-signal collection.github+4  
For mdeai, the highest-value pattern is: **OpenClaw for crawling and enrichment, Supabase as the system of record, pgvector for semantic ranking, and CopilotKit for conversational delivery**.foursquare+3

## Top GitHub repos

|Name|URL|Stars|Stack|Score /100|Best features|Useful for mdeai?|MVP or advanced?|What to steal/adapt|Risk|
|---|---|---|---|---|---|---|---|---|---|
|OpenClaw|[https://github.com/openclaw/openclaw](https://github.com/openclaw/openclaw)|N/A|OpenClaw platform, browser control, skills, gateway. github+1|97|Dedicated agent browser profile, tool/skill runner, safe browser lane. openclaw+1|Yes — core automation layer. openclaw+1|Advanced|Browser-controlled enrichment, social research, local intelligence workflows.|Medium complexity, security-sensitive browser actions.|
...
|---|---|---|---|---|
|Mindtrip|[https://mindtrip.ai](https://mindtrip.ai/)|97|Start-from-anywhere travel planning with maps, collections, nearby discovery, and local expert guides. apps.apple+4|Use multimodal intake, map-aware recommendations, and shareable collections.|
|Yelp AI assistant|[https://www.yelp.com](https://www.yelp.com/)|90|Answers questions, books reservations, and grounds responses in business pages, website, and user reviews. techcrunch+1|Great model for grounded local Q&A and action-taking in one flow.|
|Foursquare|[https://foursquare.com](https://foursquare.com/)|92|100M+ POIs, rich metadata, tips, photos, geo intelligence, and MCP-style support for agents. foursquare+2|Excellent source model for location intelligence, popularity, and geofencing.|
|GuideGeek|[https://brands.guidegeek.com](https://brands.guidegeek.com/)|86|Destination-specific conversational travel assistant via messaging channels. wikipedia+2|Strong template for WhatsApp/IG-first tourist assistance.|
|Wanderlog|[https://wanderlog.com](https://wanderlog.com/)|84|Collaborative travel planning with map view and itinerary optimization. ycombinator+2|Good planning UX, less AI-native than Mindtrip.|
|Atlas Obscura|[https://www.atlasobscura.com](https://www.atlasobscura.com/)|82|Hidden-gems storytelling with a global map of wonders. atlasobscura+1|Storytelling matters for discovery and retention.|
...
|Instagram café discovery|Find cafes tagged in Provenza, Manila, Laureles.|Surface hidden gems and creator picks.|OpenClaw browser + Instagram location extraction. github+1|High|Core|94|TOS risk, anti-bot blocks.|
...
|---|---|---|---|---|---|
|AI menu understanding|Yelp AI, Mindtrip. techcrunch+1|OrderWorder. [github](https://github.com/itzzritik/OrderWorder)|Parse menus into dishes, price bands, dietary tags, and signature items.|MVP|92|
|Best-dish extraction|Yelp review synthesis. theverge+1|combat-ai-restaurants. [github](https://github.com/iamalegambetti/combat-ai-restaurants)|“Best for arepas / espresso / date night / group brunch.”|MVP|91|
|Creator food maps|Mindtrip local experts, Travelgram. prnewswire+1|travelgram. [github](https://github.com/duncanleung/travelgram)|Build curated creator collections with venue pins.|Advanced|94|
|Instagram café extraction|Social discovery models. github+1|scrape-instagram-by-location. [github](https://github.com/timkiely/scrape-instagram-by-location)|Turn posts into venue candidates and vibe labels.|Advanced|90|
|Vibe search|Mindtrip “travel vibe.” apps.apple+1|Geo Explorer. [github](https://github.com/Free-AI-Things/Geo-Explorer)|Search by “quiet, bright, laptop-friendly, romantic, scenic.”|MVP|96|
|Semantic café search|Foursquare tags and AI discovery. foursquare+1|Geo Explorer. [github](https://github.com/Free-AI-Things/Geo-Explorer)|Rank by intent, not just category.|MVP|95|
...
|Hidden-gems system|Atlas Obscura. atlasobscura+1|OpenClaw crawl graphs. github+1|“Not obvious from Maps” layer with confidence scoring.|Advanced|92|
|Social proof systems|Yelp and Foursquare tips/photos. foursquare+2|travelgram. [github](https://github.com/duncanleung/travelgram)|Show verified signals, not raw star spam.|MVP|94|
|Authenticity scoring|Foursquare ground-truth philosophy. foursquare+1|combat-ai-restaurants. [github](https://github.com/iamalegambetti/combat-ai-restaurants)|Score on cross-source corroboration and freshness.|Advanced|95|
|Crowd intelligence|Foursquare + Yelp. foursquare+2|N/A|Use aggregate patterns, not one-off opinions.|Advanced|90|
|Atmosphere intelligence|Mindtrip nearby + guides. apps.apple+1|N/A|Label seating, lighting, noise, scenery, laptop-friendliness.|MVP|93|
|AI review summarization|Booking.com, Yelp. news.booking+1|combat-ai-restaurants. [github](https://github.com/iamalegambetti/combat-ai-restaurants)|Summarize “what people actually say” into themes.|MVP|96|
|Dynamic map markers|Mindtrip interactive maps. apps.apple+1|neighborhood-map. [github](https://github.com/sojackyso/neighborhood-map)|Pins that change based on vibe, popularity, and freshness.|MVP|94|
|Conversational maps|GuideGeek + Mindtrip. wikipedia+1|LangGraph travel agents. github+1|“Show me coffee near coworking in Laureles” and update map live.|MVP|97|
...
|Instagram/TikTok monitoring|Track creator-driven demand signals.|Search posts, extract venues, count mentions, map places. github+1|High|92|
...
The best architecture is a **three-loop system**: acquisition, intelligence, and presentation. OpenClaw should do acquisition and enrichment; Supabase should store normalized entities, sources, and signals; pgvector should power semantic similarity and taste matching; CopilotKit should present the conversational layer; and Maps/Places should remain the source of truth for geometry and travel-time grounded results.foursquare+4
...
- Use OpenClaw for venue enrichment, café/menu extraction, and creator/social discovery.github+2
...
- Ground all location results in Google Maps/Places and keep AI-generated text clearly labeled.foursquare+2
    

## Advanced recommendations

- Add multi-agent workflows for city research, creator outreach, and local SEO monitoring.github+2
    
- Add trust scoring that blends cross-source corroboration, freshness, and negative-signal detection.github+1
    
- Add shared collections and neighborhood itineraries for virality and retention.apps.apple+3
    
- Add map-story mode for hidden gems, coffee tours, and nightlife routes.atlasobscura+1
    
- Add continuous social discovery ingestion from Instagram and creator lists, with strict source labeling.github+1
