...
| Map-grounded lifestyle search | Places + Grounding + scores | V2 |
...
| WhatsApp compliance | M | H | Templates + approval |
| Maps bill shock | M | M | Cache + masks |
| Agent hallucination on lease | M | H | Propose-only + disclaimer |
