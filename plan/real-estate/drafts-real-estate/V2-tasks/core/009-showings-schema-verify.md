...
Verify migrations, FKs, indexes for CRM tables.

## Global implementation sequence

- **implementation_order:** 9 / 40 (see `V2-real-estate.md/000-index.md`).
**Global predecessor:** `RE-008` (must be complete first).
