...
Not legal advice; EN/ES.

## Global implementation sequence

- **implementation_order:** 32 / 40 (see `V2-real-estate.md/000-index.md`).
**Global predecessor:** `RE-031` (must be complete first).
