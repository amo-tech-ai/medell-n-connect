...
Weekly market_snapshots job.

## Global implementation sequence

- **implementation_order:** 36 / 40 (see `V2-real-estate.md/000-index.md`).
**Global predecessor:** `RE-035` (must be complete first).
