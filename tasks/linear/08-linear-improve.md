...
**Hub (start here):** [`linear.md`](./linear.md) — best practices + local sync.  
...
Post on [Phase 1 initiative](https://linear.app/sanjiovani/initiative/phase-1-mdeai-mvp-launch-c968b744a1a8/overview) (`Shift+U`). Template: [`templates/initiative-update.md`](./templates/initiative-update.md). Full mapping: [`12-linear-official-practices.md`](./12-linear-official-practices.md).
