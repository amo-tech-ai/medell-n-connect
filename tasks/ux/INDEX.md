...
> **Active execution pack:** [`tasks/INDEX.md`](tasks/INDEX.md) (UX-013…035) · **Linear:** [UX tasks view](https://linear.app/sanjiovani/view/ux-tasks-0e5d9fe91725) · legacy UX-001…010 specs below are archival.
...
|---|----:|----|--------|-------|-----|--------|
| 1 | 093 | UX-003 | [SAN-316](https://linear.app/sanjiovani/issue/SAN-316) | Deploy "$500 a night" price-wording parser fix | High | 🟡 code done → [UX-035](tasks/UX-035-rental-parser-prod-verify.md) |
| 2 | 094 | UX-002 | [SAN-320](https://linear.app/sanjiovani/issue/SAN-320) | Render user-facing error on RUN_ERROR/timeout | High | 🟡 → [UX-015](tasks/UX-015-ship-pr17-error-bridge-split-scope.md) |
| 3 | 095 | UX-005 | [SAN-319](https://linear.app/sanjiovani/issue/SAN-319) | Concierge "thinking" indicator (same PR as UX-002) | Med | 🟡 → UX-015 |
...
| 7 | 100 | UX-008 | [SAN-324](https://linear.app/sanjiovani/issue/SAN-324) | Fix Save tooltip copy | Low | 🟢 → [UX-027](tasks/UX-027-rental-card-copy-leaks.md) |
| 8 | 097 | UX-001 | [SAN-315](https://linear.app/sanjiovani/issue/SAN-315) | Restore conciergeAgent on prod | Critical | 🟢 |
| 9 | 096 | UX-004 | [SAN-317](https://linear.app/sanjiovani/issue/SAN-317) | Disable Events/Food chips (*optional*) | High | 🚫 Canceled |
| 10 | 102 | UX-010 | [SAN-318](https://linear.app/sanjiovani/issue/SAN-318) | Unified result-card architecture | High | 🟡 → [tasks/UX-010-CARD-UNIFICATION-STRATEGY.md](tasks/UX-010-CARD-UNIFICATION-STRATEGY.md) |
...
## PR-stack remediation (UX-013…019)

Forensic audit of PRs #17–#20 → executable tasks in **[`tasks/`](tasks/)** (2026-05-31).

| # | ID | Title | Sev |
|---|-----|-------|-----|
| 1 | UX-013 | Wire `venue_anchors` café fallback | P0 |
| 2 | UX-014 | Agent tool cards without `writer.custom` | P0 |
| 3 | UX-015 | Ship PR #17 error bridge + split scope | P0 |
| 4 | UX-016 | Playwright RUN_ERROR e2e | P1 |
| 5 | UX-019 | Event fast-path classifier (B-09) | P1 |
| 6 | UX-017 | Rebase PR #19 onto `main` | P1 |
| 7 | UX-018 | ADK URL on Vercel (Phase 2) | P2 |
