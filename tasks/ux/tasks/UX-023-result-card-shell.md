...
- [ ] CafeResultCard uses shell; visual parity verified (screenshot or test).
- [ ] RentalCard uses shell; visual parity verified.
- [ ] EventCard uses shell; `cn()` not template literals.
- [ ] `npm run floor` green.
...
| Claim | Result |
|-------|--------|
| Shell exists | ❌ Not yet |
| Rental snapshot parity | Required before Done |
